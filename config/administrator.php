...
return array(
     ...
     *                或者是 `administrator/pages/analytics.blade.php`, 两种后缀皆可.
     *
     *
     * 示例:
     *  [
     *     'users',
     *     'E-commerce'     => ['collections', 'products', 'procuct_images', 'orders'],
     ...
     * 使用布尔值来设定是否使用后台主页面
     *
     * 如：值为 `true` ,将使用 `dashboard_view` 定义的视图文件渲染页面
     * 如：值为 `fasle`, 将使用 `home_page` 定义的菜单条目来作为后台主页
     */
    'use_dashboard' => false,
